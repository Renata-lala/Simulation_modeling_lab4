...
namespace ИМ_лаба4
{
    public partial class Form1 : Form
    {
        ...
        private void NextGeneration()
        {
            ...
            for (int i = 0; i < cols; i++)
            {
                for (int j = 0; j < rows; j++)
                {
                    ...
                    if (field[i, j])
                    {
                        graphics.FillRectangle(Brushes.PeachPuff, i * resolution, j * resolution, resolution, resolution);
                    }
                }
            }
            field = newfield;   
        ...
        private void StartGame()
        {
            ...
            graphics.FillRectangle(Brushes.PeachPuff, 0, 0, resolution, resolution);
